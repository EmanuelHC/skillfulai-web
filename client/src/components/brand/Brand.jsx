...
import { aws, bnb, pytorch, ethereum, tensorflow, langchain, huggingface, polygonID, wallet_connect, polygon } from './import';
import './brand.css';

const Brand = () => (
  <div className="skilfullai__brand section__padding">
    <div className='skilfullai__brand-row skilfullai__brand-row1'>
      <img src={aws} alt='aws' />
      <img src={bnb} alt='bnb'/>
    ...
    <div className='skilfullai__brand-row skilfullai__brand-row2'>
